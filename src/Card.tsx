...
<div className="max-w-md mx-auto bg-white rounded-full shadow-md  md:max-w-2xl ">
<div className="md:flex  ">
  <div className="md:flex-shrink-0   sd:flex-shrink-2">
    <img className=" rounded-full h-48 w-full object-cover  md:w-48 sd:h-2" src={icon} alt="Man looking at item at a store"/>
  </div>
  <div className="p-8">
